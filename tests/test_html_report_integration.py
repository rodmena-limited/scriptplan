...
from rodmena_resource_management.report.report import Report, ReportFormat, ReportType
...
class TestHtmlDocumentBuilding(unittest.TestCase):
    ...
    def test_build_document_with_content(self):
        ...
        from rodmena_resource_management.report.html_generator import build_html_document
...
class TestHtmlGeneratorInReport(unittest.TestCase):
    ...
    def test_build_html_document_callable(self):
        ...
        from rodmena_resource_management.report.report import build_html_document

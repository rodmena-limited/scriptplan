...
from rodmena_resource_management.report.report_context import ReportContext
...
class Report(PropertyTreeNode, MessageHandler):
    ...
    def generate_intermediate_format(self) -> None:
        ...
        if self.type_spec == ReportType.TASK_REPORT:
            ...
            # from rodmena_resource_management.report.account_report import AccountReport
            # self.content = AccountReport(self)
            pass
        elif self.type_spec == ReportType.TRACE_REPORT:
            # from rodmena_resource_management.report.trace_report import TraceReport
            # self.content = TraceReport(self)
            pass
        elif self.type_spec == ReportType.STATUS_SHEET:
            # from rodmena_resource_management.report.status_sheet_report import StatusSheetReport
            # self.content = StatusSheetReport(self)
            pass
        elif self.type_spec == ReportType.TIME_SHEET:
            # from rodmena_resource_management.report.time_sheet_report import TimeSheetReport
            # self.content = TimeSheetReport(self)
            pass
        elif self.type_spec == ReportType.ICAL:
            # from rodmena_resource_management.report.ical_report import ICalReport
            # self.content = ICalReport(self)
            pass
        elif self.type_spec == ReportType.NIKU:
            # from rodmena_resource_management.report.niku_report import NikuReport
            # self.content = NikuReport(self)
            pass
        elif self.type_spec == ReportType.EXPORT:
            # from rodmena_resource_management.report.export_report import ExportReport
            # self.content = ExportReport(self)
            pass
        elif self.type_spec == ReportType.TAG_FILE:
            # from rodmena_resource_management.report.tag_file import TagFile
    ...
    def _build_subtitle(self) -> str:
        ...
        if start and end:
            from rodmena_resource_management.report.html_generator import format_date

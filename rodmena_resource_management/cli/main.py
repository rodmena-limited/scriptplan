#!/usr/bin/env python3
"""
Rodmena Resource Management CLI.

This is the main command-line interface for the Rodmena Resource Management
application (Python implementation of TaskJuggler). It reads project files,
schedules the project, and generates reports.

Usage:
    rodmena [options] <project_file.tjp> [additional_files...]

Examples:
    rodmena project.tjp
    rodmena --output-dir ./reports project.tjp
    rodmena --check-syntax project.tjp
    rodmena --report task_list project.tjp
"""
...
from rodmena_resource_management import __version__
...
def setup_logging(debug_level: int = 0, debug_modules: Optional[List[str]] = None) -> None:
    ...
    if debug_modules:
        ...
        for module in debug_modules:
            logging.getLogger(f'rodmena_resource_management.{module}').setLevel(level)
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog='rodmena',
        description='Rodmena Resource Management - A Python implementation of TaskJuggler',
        epilog='For more information, visit: https://github.com/rodmena/resource-management',
...
class Rodmena:
    """
    Main application class for Rodmena Resource Management.
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.errors = 0
        self.warnings = 0
        self.logger = logging.getLogger('rodmena_resource_management.cli')
    ...
    def generate_reports(self) -> bool:
        ...
        from rodmena_resource_management.report import ReportContext
